...
interface ILangaraProps {
  custom: number;
}

const Langara: React.FunctionComponent<ILangaraProps> = (props) => {
  return (
    <>
      <motion.div
      ...
      >
        <div className="col-start-2 col-span-2 row-start-1 row-span-1 flex justify-start flex-col-reverse gap-10">
          <div className="flex justify-between items-center">
            <h2 className="text-6xl self-start text-white">
              Dynamics 365 <span className="text-[#fc7c2c]">Higher-Ed</span>
            </h2>
        ...
        <div className="col-start-2 col-span-2 row-start-2 row-span-3 overflow-hidden py-12">
          <h3 className="text-lg">
            ...
            <span className="text-[#fc7c2c]"> cost-efficient</span> student
            portal
          </h3>
